            ...
            <table id="myTable" class="table table-striped table-bordered table-sm">
                ...
                <thead class="filters">
                    <tr>
                        ...
                        <th class="th-sm">Nombre del Delito</th>
                        <th class="th-sm">Comuna del delito</th>
                        <th class="th-sm">Sector del delito</th>
                        <th class="th-sm">Nombre de la calle del delito</th>
                        <th class="th-sm">Fecha del delito</th>
                ...
                <tbody>
                    <?php foreach ($delitos as $item) { ?>
                        <tr>
                            <td><?php echo $item->delincuente_iddelincuente ?></td>
                            <td><?php echo $item->delito_iddelito  ?></td>
                            <td><?php echo $item->comuna_idcomuna ?></td>
                            <td><?php echo $item->sector_idsector ?></td>
                            <td><?php echo $item->direccion_delito ?></td>
                            <td><?php echo $item->fecha_delito ?></td>
